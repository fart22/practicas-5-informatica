...
int main()
{
  ...
  /* Calcular el valor de resistencia más cercano según las tablas */
  ...
  /* Mostrar por pantalla el valor de resistencia de la tabla más cercano */
  /* al que se había introducido por teclado, es decir, el elemento "imenor"
